...
<body>
    ...
    <div class="team-boxed">
        ...
        <?php 
                    ...
                    $sql = "SELECT * FROM quizes where sub_topic_name=:sub_topic_name";
                ...
                <h2 class="text-center">Test Your Knowledge On <?php echo htmlentities($result->sub_topic_name);?></h2>
                <div class="team-boxed-tagline">
                <p class="text-center"><?php echo htmlentities($result->sub_topic_name);?> is a sub-topic under <?php echo htmlentities($result->parent_topic_name);?></p>
            ...
            <div class="row" style="margin: auto">
                ...
                <!-- <div class="riddle_target" data-rid-id="352220" data-fg="#FF00FF" data-bg="rgba(0, 0, 0, 0.3)" style="margin:0 auto;max-width:100%;width:500px;" data-auto-scroll="true" data-auto-scroll-offset="5">
                <script src="https://www.riddle.com/embed/files/js/embed.js"></script>
                <link href="https://www.riddle.com/embed/files/css/embed.css" rel="stylesheet">
                <iframe style="width:100%;height:250px;border:1px solid #cfcfcf;" src="https://www.riddle.com/embed/a/352220?" allow="autoplay" title="Quiz - Quiz on Queues"><section><h2><h2><strong>Quiz on Queues</strong></h2></h2></section><section><h2><h2>Which deletion can be insertion take place only at the other end(rear) and done from one end (front)?<br /></h2></h2></section><section><h3><h2>For Breadth-First Traversal on a graph is the data structure required?<br /></h2></h3></section><section><h3><h2>Queue follows __________<br /></h2></h3></section><section><h3><h2>Circular Queue is also called ________</h2></h3></section><section><h2></h2></section><section><h3></h3></section></iframe>
                </div> -->
