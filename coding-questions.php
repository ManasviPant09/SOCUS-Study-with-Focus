...
<body>
    ...
    <div class="team-boxed">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">Coding Questions To Practice On<br><?php echo htmlentities($_GET['sub_topic_name']);?></h2>
            </div>
            <div class="row people">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM coding_questions WHERE sub_topic_name=:sub_topic_name ORDER BY difficulty_level ASC";
                    ...
                    {               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->parent_topic_name);?></td>
                                            <td class="center"><?php echo htmlentities($result->sub_topic_name);?></td>
                                            <td class="center"><?php echo htmlentities($result->question_title);?></td>
                                            <td class="center"><?php echo htmlentities($result->difficulty_level);?></td>
                                            <td>
                                                <div><button class="button-3" role="button" onclick="location.href='compiler.php?qid=<?php echo htmlentities($result->id);?>';">Solve</button></div>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
